...
public class FindTheUnknowDigit {
    ...
    public static class Expression {
        ...
        boolean isTrueWithDigit(String digit) {
            ...
            return (!n1.equals(0) || s1.length() <= 1) && (!n2.equals(0) || s2.length() <= 1) && (!res.equals(0) || r.length() <= 1) && this.operand.apply(n1, n2).equals(res);
